/**
  ...
  * @brief   OLED屏幕驱动程序
						...
						端口定义：
							PC2:  OLED_DC 	OLED 数据命令选择端口
							PD8:  OLED_RST 	OLED 复位引脚
							PB13: OLED_SCLK OLED 时钟引脚
							PC3:  OLED_SDIN OLED 数据输出引脚
							PB12: OLED_CS 	OLED 片选引脚
  ******************************************************************************
**/	
#include "oled.h"
#include "oledfont.h"
...
void OLED_Hardware_Init(void)
{
    ...
    __HAL_RCC_GPIOC_CLK_ENABLE();           //开启GPIOC时钟
		...
		GPIO_Initure.Pin=GPIO_PIN_2|GPIO_PIN_3; //PC2,3
    GPIO_Initure.Mode=GPIO_MODE_OUTPUT_PP;  //推挽输出
    GPIO_Initure.Pull=GPIO_PULLUP;          //上拉
    GPIO_Initure.Speed=GPIO_SPEED_HIGH;     //高速
    HAL_GPIO_Init(GPIOC,&GPIO_Initure);			//初始化端口	

    GPIO_Initure.Pin=GPIO_PIN_12|GPIO_PIN_13|GPIO_PIN_15;//PB12,13,15
    GPIO_Initure.Mode=GPIO_MODE_OUTPUT_PP;  //推挽输出
    GPIO_Initure.Pull=GPIO_PULLUP;          //上拉
    GPIO_Initure.Speed=GPIO_SPEED_HIGH;     //高速

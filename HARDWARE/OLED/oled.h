...
#define OLED_DC 	PCout(2) 		//DC    	数据命令选择端口
#define OLED_RST 	PBout(15) 	//RES	 	复位引脚
#define OLED_SCLK PBout(13)		//SCLK	 时钟引脚
#define OLED_SDIN PCout(3) 		//SDIN	 数据输出引脚
#define OLED_CS 	PBout(12)		//CS		 片选引脚
